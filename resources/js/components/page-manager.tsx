...
export function PageManager({ onPageSelect, currentContent, currentFilename }: PageManagerProps) {
    ...
    const loadPage = async (filename: string) => {
        try {
            ...
            onPageSelect(response.data.content, response.data.filename);
        } catch (error) {
    ...
    return (
        <div className="flex flex-col gap-4 p-4 border border-sidebar-border rounded-lg">
